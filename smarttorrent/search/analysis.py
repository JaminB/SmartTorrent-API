...
class Wordlist:
	...
	def get_good_verbs(self):
		#returns a list of positive verbs found in wordlist.wl
		return self.goodVerbs

	def get_good_nouns(self):
		#returns a list of positive nouns found in wordlist.wl
	...
	def get_bad_verbs(self):
		#returns a list of negative verbs found in wordlist.wl
		return self.badVerbs
	
	def get_bad_nouns(self):
		#returns a list of negative nouns found in wordlist.wl
...
class Signatures:
	...
	def __init__(self, comment):
		wordlist = Wordlist()
		self.comment = comment
		#Wordlists broken down by positive or negative connotations and gramatical categories
	...
	def sig_bad_quality(self):
		#Signature for detecting comments referencing the content as "bad quality" weight -10
	...
	def sig_good_quality(self):
		#Signature for detecting comments referencing the content as "good quality" weight +10
	...
	def sig_rated_content(self):
		#Extracts in comment ratings such as "Audio: 10 Video: 10" weight varies
		rating = 0
