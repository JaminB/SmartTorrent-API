	...
	def analyze_comments(self):
		for commentList in self.comments:
			...
			for comment in commentList:
				...
				analyzedCommentsBlock.append((analyze.get_cache().get_comment(), analyze.get_cache().get_comment_rating(), analyze.get_cache().get_flagged_words(), analyze.get_cache().get_context_words()))
